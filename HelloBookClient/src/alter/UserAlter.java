...
public class UserAlter {
	...
	public UserAlter(String Requester_ID,String Book_Number, String Book_Title,String Requested_ID,String Request_Status,String is_Treatmented) {
	...
	public String toString() {
		if(Request_Status.equals("∫Ù∏Æ¥Ÿ")) {
			return Requester_ID+"¥‘¿Ã √• ["+Book_Title+"]∏¶(¿ª) ∫Ù∏Æ∞Ì ΩÕæÓ«’¥œ¥Ÿ.";
		}else 	if(Request_Status.equals("∫Ù∑¡¡÷¥Ÿ")) {
			return "√• ["+Book_Title+"]∏¶(¿ª) ∫Ù∑»Ω¿¥œ¥Ÿ.";
		}else 	if(Request_Status.equals("æ»∫Ù∑¡¡÷¥Ÿ")) {
			return Requester_ID+"¥‘¿Ã √• ["+Book_Title+"]∏¶(¿ª) ∫Ù∑¡¡÷¥¬∞Õ¿ª ∞≈∫Œ«œºÃΩ¿¥œ¥Ÿ.";
		}else {
			return null;
		}
	}
